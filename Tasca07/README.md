# 🛠️ Estandardització d’Eina d’Assistència Remota – EverPia

## 🎯 Objectiu

Disposar d’una eina d’assistència remota **sota demanda**, ràpida, fiable i segura, que funcioni en segons fins i tot en **xarxes restrictives**, sense necessitat de VPNs ni configuracions complexes per part del client.
...
*(📸 Captura: Camp d’ID i botó Connectar)*

---

### 3️⃣ Funcions Clau

* 📂 **Transferència d’arxius**: icona de carpeta o arrossegar i deixar anar
* 🖥️ **Canvi de pantalla**: útil en equips amb múltiples monitors
* 🔄 **Reinici remot**: opció “Restart Remote Device”

*(📸 Captures de cada funció)*
...
* ✅ Tancar sempre la sessió en finalitzar
* 🔒 Utilitzar només el compte corporatiu
* 👀 Verificar sempre amb el client abans de prendre control

---

## 👤 Guia 2 – Manual per al Client (Usuari Final)

> 📌 **Aquesta guia s’envia directament al client. Ha de ser simple i visual.**
...
*(📸 Captura amb el botó de descàrrega ressaltat)*
...
### 3️⃣ Acceptar la Connexió

1. Quan el tècnic es connecti, apareixerà una finestra
2. Fer clic a **Acceptar** ✅
3. Relaxi’s ☕ — el tècnic ja pot ajudar-lo

*(📸 Captura de la finestra d’acceptació)*
